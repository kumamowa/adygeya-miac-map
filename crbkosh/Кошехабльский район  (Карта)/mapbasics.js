...
myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
myMap.geoObjects.add(fap2).add(fap6).add(fap7).add(fap8).add(fap9);
myMap.geoObjects.add(amb1).remove(amb2).remove(amb3).remove(amb4).remove(amb5).remove(amb6);
myMap.geoObjects.add(gran_drujba).add(gran_chehrak1).add(gran_chehrak2).add(gran_otradn).add(gran_novoaleks).add(gran_dmtr).add(gran_plod);
myMap.geoObjects.add(gran_kosh).add(gran_egeruhay).add(gran_polit).add(gran_chatchemsiy).add(gran_krasnfars).add(gran_komsomol);
});
crb.events.add('balloonclose', function () {
myMap.geoObjects.remove(gran_drujba).remove(gran_chehrak1).remove(gran_chehrak2).remove(gran_otradn).remove(gran_novoaleks).remove(gran_dmtr).remove(gran_plod);
myMap.geoObjects.remove(gran_kosh).remove(gran_egeruhay).remove(gran_polit).remove(gran_chatchemsiy).remove(gran_krasnfars).remove(gran_komsomol);
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap1).add(fap3).add(fap4).add(fap5).add(fap10);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
if ($('#ter').prop('checked'))
myMap.geoObjects.add(gran_rajon);
if ($('#amb').prop('checked'))
myMap.geoObjects.add(amb2);
});
...
myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
myMap.geoObjects.remove(crb).remove(amb2).remove(amb3).remove(amb4).remove(amb5).remove(amb6);
myMap.geoObjects.add(fap2).add(fap6).add(fap7).add(fap8).add(fap9);
myMap.geoObjects.add(gran_drujba).add(gran_chehrak1).add(gran_chehrak2).add(gran_otradn).add(gran_novoaleks).add(gran_dmtr).add(gran_plod);
myMap.geoObjects.add(gran_egeruhay).add(gran_polit).add(gran_chatchemsiy).add(gran_krasnfars).add(gran_komsomol);
});
amb1.events.add('balloonclose', function () {
myMap.geoObjects.remove(gran_drujba).remove(gran_chehrak1).remove(gran_chehrak2).remove(gran_otradn).remove(gran_novoaleks).remove(gran_dmtr).remove(gran_plod);
myMap.geoObjects.remove(gran_egeruhay).remove(gran_polit).remove(gran_chatchemsiy).remove(gran_krasnfars).remove(gran_komsomol);
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap1).add(fap3).add(fap4).add(fap5).add(fap10);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
...
myMap.geoObjects.remove(gran_krasn);
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap1).add(fap2).add(fap3).add(fap4).add(fap5).add(fap6).add(fap7).add(fap8).add(fap9);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
if ($('#ter').prop('checked'))
myMap.geoObjects.add(gran_rajon);
...
myMap.geoObjects.remove(gran_ignat);
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap1).add(fap2).add(fap3).add(fap5).add(fap6).add(fap7).add(fap8).add(fap9).add(fap10);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
if ($('#ter').prop('checked'))
myMap.geoObjects.add(gran_rajon);
...
myMap.geoObjects.remove(gran_kazen);
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap2).add(fap3).add(fap4).add(fap5).add(fap6).add(fap7).add(fap8).add(fap9).add(fap10);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
if ($('#ter').prop('checked'))
myMap.geoObjects.add(gran_rajon);
...
myMap.geoObjects.add(fap3).add(fap5);
...
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap1).add(fap2).add(fap4).add(fap6).add(fap7).add(fap8).add(fap9).add(fap10);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
if ($('#ter').prop('checked'))
myMap.geoObjects.add(gran_rajon);
...
if ($('#fap').prop('checked'))
myMap.geoObjects.add(fap1).add(fap2).add(fap3).add(fap4).add(fap5).add(fap6).add(fap7).add(fap8).add(fap9).add(fap10);
else
	myMap.geoObjects.remove(fap1).remove(fap2).remove(fap3).remove(fap4).remove(fap5).remove(fap6).remove(fap7).remove(fap8).remove(fap9).remove(fap10);
if ($('#ter').prop('checked'))
myMap.geoObjects.add(gran_rajon);
