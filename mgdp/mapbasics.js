...
function init() {
	...
	myGeoObject1 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [44.593589, 40.122199]
        },
            // Свойства.
        properties: {
		hintContent: 'Майкопская городская детская поликлиника<br/>Отделение №1<br/>ул. Заводская, 3',
		balloonContentBody: [
            '<strong>Майкопская городская детская поликлиника',
			'<br/>',
			'Отделение №1',
			'<br/>',
			'ул. Заводская, 3</strong>',
			'<br/>',
			'<br/>',
	...
	myGeoObject2 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [44.617063, 40.104668]
        },
            // Свойства.
        properties: {
		hintContent: 'Майкопская городская детская поликлиника<br/>Отделение №2<br/>ул. Ленина, 92',
		balloonContentBody: [
            '<strong>Майкопская городская детская поликлиника',
			'<br/>',
			'Отделение №2',
	...
	myGeoObject3 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [44.611202, 40.074475]
        },
            // Свойства.
        properties: {
		hintContent: 'Майкопская городская детская поликлиника<br/>Отделение №3<br/>ул. Пионерская, 500',
		balloonContentBody: [
            '<strong>Майкопская городская детская поликлиника',
			'<br/>',
			'Отделение №3',
			'<br/>',
			'ул. Пионерская, 500</strong>',
			'<br/>',
			'<br/>',
			'Обслуживаемое население: 9999',
			'<br/>',
